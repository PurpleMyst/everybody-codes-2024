...
fn bench_quest07(c: &mut Criterion) {
    let input1 = include_str!("../../quest07/src/part1.txt");
    c.bench_function("quest07_part1", |b| b.iter(|| quest07::solve_part1(black_box(input1))));

    let input2 = include_str!("../../quest07/src/part2.txt");
    c.bench_function("quest07_part2", |b| b.iter(|| quest07::solve_part2(black_box(input2))));

    let input3 = include_str!("../../quest07/src/part3.txt");
    c.bench_function("quest07_part3", |b| b.iter(|| quest07::solve_part3(black_box(input3))));
}

fn bench_quest08(c: &mut Criterion) {
    let input1 = include_str!("../../quest08/src/part1.txt");
    c.bench_function("quest08_part1", |b| b.iter(|| quest08::solve_part1(black_box(input1))));

    let input2 = include_str!("../../quest08/src/part2.txt");
    c.bench_function("quest08_part2", |b| b.iter(|| quest08::solve_part2(black_box(input2))));

    let input3 = include_str!("../../quest08/src/part3.txt");
    c.bench_function("quest08_part3", |b| b.iter(|| quest08::solve_part3(black_box(input3))));
}

fn bench_quest09(c: &mut Criterion) {
    let input1 = include_str!("../../quest09/src/part1.txt");
    c.bench_function("quest09_part1", |b| b.iter(|| quest09::solve_part1(black_box(input1))));

    let input2 = include_str!("../../quest09/src/part2.txt");
    c.bench_function("quest09_part2", |b| b.iter(|| quest09::solve_part2(black_box(input2))));

    let input3 = include_str!("../../quest09/src/part3.txt");
...
fn bench_quest11(c: &mut Criterion) {
    let input1 = include_str!("../../quest11/src/part1.txt");
    c.bench_function("quest11_part1", |b| b.iter(|| quest11::solve_part1(black_box(input1))));

    let input2 = include_str!("../../quest11/src/part2.txt");
    c.bench_function("quest11_part2", |b| b.iter(|| quest11::solve_part2(black_box(input2))));

    let input3 = include_str!("../../quest11/src/part3.txt");
    c.bench_function("quest11_part3", |b| b.iter(|| quest11::solve_part3(black_box(input3))));
}
